...
class SocialMediaLossPageSpec extends AnyFreeSpec with Matchers {
  ...
  "ReportMediaAlternativeChargePage" - {
    "cleanup" - {
      ...
      "must remove ReportSocialMediaOperatingMarginPage when there is a change of the answer from 'No' to 'Yes'" in {
      ...
      "must retain ReportSocialMediaOperatingMarginPage when there is a change of the answer to 'No'" in {
