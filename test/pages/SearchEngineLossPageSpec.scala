...
class SearchEngineLossPageSpec extends AnyFreeSpec with Matchers {
  ...
  "SearchEngineLossPage" - {
    "cleanup" - {
      ...
      "must remove ReportSearchEngineOperatingMarginPage when there is a change of the answer from 'No' to 'Yes'" in {
      ...
      "must retain ReportSearchEngineOperatingMarginPage when there is a change of the answer to 'No'" in {
