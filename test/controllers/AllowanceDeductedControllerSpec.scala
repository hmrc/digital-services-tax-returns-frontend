...
class AllowanceDeductedControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new AllowanceDeductedFormProvider()
  ...
  "AllowanceDeducted Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, allowanceDeductedRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, allowanceDeductedRoute)
