...
class SearchEngineLossControllerSpec extends SpecBase with MockitoSugar {
  ...
  "SearchEngineLoss Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, searchEngineLossRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, searchEngineLossRoute)
