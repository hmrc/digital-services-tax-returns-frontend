...
import models.{NormalMode, UKBankDetails, UserAnswers}
...
class UKBankDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  val userAnswers = emptyUserAnswers
    .set(UKBankDetailsPage(periodKey), UKBankDetails("Name", "123456", "12345678", None))
    .success
    .value

  "UKBankDetails Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, uKBankDetailsRoute)

        val view = application.injector.instanceOf[UKBankDetailsView]
