...
class ReportOnlineMarketplaceOperatingMarginControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val reportOnlineMarketplaceOperatingMarginRoute = routes.ReportOnlineMarketplaceOperatingMarginController.onPageLoad(NormalMode).url
  ...
  "ReportOnlineMarketplaceOperatingMargin Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, reportOnlineMarketplaceOperatingMarginRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ReportOnlineMarketplaceOperatingMarginPage, validAnswer).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, reportOnlineMarketplaceOperatingMarginRoute)
