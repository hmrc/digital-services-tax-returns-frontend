...
class ReportOnlineMarketplaceLossControllerSpec extends SpecBase with MockitoSugar {
  ...
  "ReportOnlineMarketplaceLoss Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, reportOnlineMarketplaceLossRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, reportOnlineMarketplaceLossRoute)
