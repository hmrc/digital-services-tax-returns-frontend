...
class ReportOnlineMarketplaceAlternativeChargeController @Inject() (
  ...
  formProvider: ReportOnlineMarketplaceAlternativeChargeFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: ReportOnlineMarketplaceAlternativeChargeView
